...
(function ($) {
    ...
    //点击确定后的响应函数
    var okBtn_click = function () {
        var txt_email = $("#txt_email").val();
        var txt_content = $("#txt_content").val();
        var txt_productName = $("#txt_productName").val();
        var txt_yourName = $("#txt_yourName").val();
        var txt_company = $("#txt_company").val();
        var txt_tel = $("#txt_tel").val();
        var txt_msn = $("#txt_msn").val();
        var txt_language = $("#purebox-inquire").attr("language"); //访问语言
        var txt_recievedId = $("#purebox-inquire").attr("reciever"); //接受者
        ...
        */
        ...
        $.ajax({
            type: "GET",
            url: "http://localhost:3978/api/EnquirySave/SaveData?callback=?",
            data: { email: txt_email, content: txt_content, productName: txt_productName, yourName: txt_yourName, company: txt_company, tel: txt_tel, msn: txt_msn, language: txt_language, recievedId: txt_recievedId },
            dataType: "jsonp",
    ...
    purebox.fn = purebox.prototype = {
        ...
        _init: function (options) {
            var opts = $.extend({}, purebox.defaults, options || {}),
				template = ['<div id="', opts.id, '" class="pb">',
			               ...
			               opts.foot ? ('<div class="pb-ft">' + (opts.cBtn ? '<a class="pb-btn pb-cl">Close</a>' : '') + '<a class="pb-btn pb-ok">Send</a></div>') : '',
			               '</div></div>'].join(''),
			    $pb = $(template),
				$head = $pb.find('.pb-hd'),
				$foot = $pb.find('.pb-ft'),
            ...
            //            var showContent = "<table style = \"cursor: move; height: 440px; width: 500px; background: none repeat scroll 0% 0% rgb(255, 255, 255); text-align: center; opacity: 0.9;border-width:0px;\"><tr class=\"eachitem\"><td class=\"etwleft\"><b>*</b>Email</td><td class=\"etwright\"><input id=\"txt_email\" class=\"textarea_style\" type=\"text\" style=\"font-weight: bold; color: rgb(153, 0, 0);\"/></td></tr>";
            //            showContent += "<tr class=\"eachitem\"><td class=\"etwleft\"><b>*</b>Content</td><td class=\"etwright\"><textarea id=\"txt_content\" name=\"content\" style=\"width: 330px; height: 131px;\"></textarea></td></tr>";
            //            showContent += "<tr class=\"eachitem\"><td class=\"etwleft\"><b>*</b>Product Name</td><td class=\"etwright\"><input id=\"txt_productName\" class=\"textarea_style\" type=\"text\" style=\"font-weight: bold; color: rgb(153, 0, 0);\" value=\"" + window.location.href + "\"/></td></tr>";
            //            showContent += "<tr class=\"eachitem\"><td class=\"etwleft\">Your Name</td><td class=\"etwright\"><input id=\"txt_yourName\" class=\"textarea_style\" type=\"text\" style=\"font-weight: bold; color: rgb(153, 0, 0);\"/></td></tr>";
            //            showContent += "<tr class=\"eachitem\"><td class=\"etwleft\">Company</td><td class=\"etwright\"><input id=\"txt_company\" class=\"textarea_style\" type=\"text\" style=\"font-weight: bold; color: rgb(153, 0, 0);\"/></td></tr>";
            //            showContent += "<tr class=\"eachitem\"><td class=\"etwleft\">Tel</td><td class=\"etwright\"><input id=\"txt_tel\" class=\"textarea_style\" type=\"text\" style=\"font-weight: bold; color: rgb(153, 0, 0);\"/></td></tr>";
            //            showContent += "<tr class=\"eachitem\"><td class=\"etwleft\">Msn</td><td class=\"etwright\"><input id=\"txt_msn\" class=\"textarea_style\" type=\"text\" style=\"font-weight: bold; color: rgb(153, 0, 0);\"/></td></tr>";
            //showContent += "<tr style=\"width:100%;\"><td></td><td><input id=\"btn_send\" class=\"btn_send\" type=\"button\" value=\"Send\"/></td></tr>";

            that.resize(opts.width, opts.height);
            var showContent = "<div style = \"cursor: move; height: 440px; width: 500px; background: none repeat scroll 0% 0% rgb(255, 255, 255); text-align: center; opacity: 0.9;border-width:1px;\"><div class=\"etwdiv\"><div class=\"eachitem\"><div class=\"left\"><b>*</b>Email</div><div class=\"right\"><input id=\"txt_email\" class=\"textarea_style\" type=\"text\" style=\"font-weight: bold; color: rgb(153, 0, 0);\"/></div></div>";
            showContent += "<div class=\"eachitem\"><div class=\"left\"><b>*</b>Content</div><div class=\"right\"><textarea id=\"txt_content\" name=\"content\" class=\"textarea_style\"></textarea></div></div>";
            showContent += "<div class=\"eachitem\"><div class=\"left\"><b>*</b>Product Name</div><div class=\"right\"><input id=\"txt_productName\" class=\"textarea_style\" type=\"text\" style=\"font-weight: bold; color: rgb(153, 0, 0);\" value=\"" + window.location.href + "\"/></div></div>";
            showContent += "<div class=\"eachitem\"><div class=\"left\">Your Name</div><div class=\"right\"><input id=\"txt_yourName\" class=\"textarea_style\" type=\"text\" style=\"font-weight: bold; color: rgb(153, 0, 0);\"/></div></div>";
            showContent += "<div class=\"eachitem\"><div class=\"left\">Company</div><div class=\"right\"><input id=\"txt_company\" class=\"textarea_style\" type=\"text\" style=\"font-weight: bold; color: rgb(153, 0, 0);\"/></div></div>";
            showContent += "<div class=\"eachitem\"><div class=\"left\">Tel</div><div class=\"right\"><input id=\"txt_tel\" class=\"textarea_style\" type=\"text\" style=\"font-weight: bold; color: rgb(153, 0, 0);\"/></div></div>";
            showContent += "<div class=\"eachitem\"><div class=\"left\">Msn</div><div class=\"right\"><input id=\"txt_msn\" class=\"textarea_style\" type=\"text\" style=\"font-weight: bold; color: rgb(153, 0, 0);\"/></div></div>";
            showContent += "</div></div>";

            //showContent += "</table>";
            that.setContent($(showContent));
        ...
        resize: function (width, height) {
            var that = this;
            that.$pb.css('width', max.call(Math, 150, 500) + 'px');
            that.$cont.css('height', max.call(Math, 50, 440) + 'px');
            return that;
        },
        //设置位置
